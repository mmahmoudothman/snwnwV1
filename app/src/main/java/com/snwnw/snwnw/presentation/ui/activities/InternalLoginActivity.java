...
public class InternalLoginActivity extends AppCompatActivity implements LoginPresenterListener {
    ...
    public void goRegister() {
        Intent intent = new Intent(InternalLoginActivity.this, registerActivity.class);
    ...
    public void LoginNow() {
        ...
        if (Connectivity.isConnected(InternalLoginActivity.this) == true) {
            ...
            if (user_email.getText().toString().trim().length() == 0) {
                ...
                RegisterPresenter presenter = new RegisterPresenter(InternalLoginActivity.this, InternalLoginActivity.this);
    ...
    public void onLoginSuccess(user_model user_model) {
       SNWNWPrefs.setDefaults(Constants.Token, user_model.getToken(), InternalLoginActivity.this);
        SNWNWPrefs.set_Int_value(Constants.UserId, user_model.getId(), InternalLoginActivity.this);
         //goMenu();
    ...
    public void goMenu() {
        Intent go = new Intent(InternalLoginActivity.this, testAcitivty.class);
        startActivity(go);
        finish();
    }
    ...
    public void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            if (ContextCompat.checkSelfPermission(InternalLoginActivity.this, Manifest.permission.READ_PHONE_STATE) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(InternalLoginActivity.this, new String[]{Manifest.permission.READ_PHONE_STATE}, REQUEST_PHONE);
            } else {
